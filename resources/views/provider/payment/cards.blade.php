...
<div class="pro-dashboard-head">
    <div class="container">
        ...
        <a href="{{url('provider/subscribe/cards')}}"" class="pro-head-link active">@lang('admin.include.Card')</a> 
    </div>
</div>
                    ...
                    @include('common.notify')                         
                     ...
                     <div class="tab-content list-content">
                        <div class="list-view pad30 ">
                            ...
                            @endif
                            <a href="#" class="sub-right pull-right" data-toggle="modal" data-target="#add-card-modal" style="margin-right: 10px;margin-bottom: 10px;">@lang('provider.card.add_card')</a>
                            <table class="earning-table table table-responsive">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="2">@lang('provider.card.notfoundcard')</td>
                                       </tr>
                                    @endif
                                </tbody>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content" >
          <div class="modal-header">
            ...
            <form id="payment-form" action="{{ url('provider/subscribe/card/store') }}" method="POST" >
                {{ csrf_field() }}
