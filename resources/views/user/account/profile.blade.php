        ...
        <div class="row no-margin">
            <form>
                ...
                <div class="col-md-6 pro-form">
                    ...
                    <p class="col-md-6 no-padding">{{symbolcurrency(Auth::user()->wallet_balance,Auth::user()->country->currency_code)}}</p>
                </div>   

                 <div class="col-md-6 pro-form">
                    <h5 class="col-md-6 no-padding"><strong>Country</strong></h5>
                    <p class="col-md-6 no-padding">{{Auth::user()->country->name}}</p>
                </div>   

                 <div class="col-md-6 pro-form">
                    <h5 class="col-md-6 no-padding"><strong>City</strong></h5>
                    <p class="col-md-6 no-padding">{{Auth::user()->city->name}}</p>
                </div>                  
