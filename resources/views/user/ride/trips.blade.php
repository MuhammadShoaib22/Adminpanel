                ...
                <table class="table table-condensed" style="border-collapse:collapse;">
                    ...
                    @foreach($trips as $trip)
                        ...
                        <tr data-toggle="collapse" data-target="#trip_{{$trip->id}}" class="accordion-toggle collapsed">
                            ...
                            @endif
                            @if($trip->payment)
                                <td>{{symbolcurrency($trip->payment->total,$trip->currency_code)}}</td>
                            @else
                                <td>-</td>
                            @endif
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mytrip-right">
                                            ...
                                            <div class="fare-break">
                                                ...
                                                @if($trip->payment)
                                                    {{symbolcurrency($trip->payment->fixed,$trip->currency_code)}}
                                                @endif
                                                </span></h5>
                                                @if($trip->service_type->calculator=='MIN')
                                                    <h5>@lang('user.ride.minutes_price') <span>
                                                    @if($trip->payment)
                                                        {{symbolcurrency($trip->payment->minute,$trip->currency_code)}}
                                                    @endif
                                                    </span></h5>
                                                @endif
                                                @if($trip->service_type->calculator=='HOUR')
                                                    ...
                                                    @if($trip->payment)
                                                        {{symbolcurrency($trip->payment->hour,$trip->currency_code)}}
                                                    @endif
                                                    </span></h5>
                                                @endif
                                                @if($trip->service_type->calculator=='DISTANCE')
                                                    ...
                                                    @if($trip->payment)
                                                        {{symbolcurrency($trip->payment->distance,$trip->currency_code)}}
                                                    @endif
                                                    </span></h5>
                                                @endif
                                                 ...
                                                 @if($trip->payment)
                                                    @if($trip->payment->wallet)
                                                        <h5>@lang('user.ride.wallet_deduction') <span>
                                                            {{symbolcurrency($trip->payment->wallet,$trip->currency_code)}}
                                                        </span></h5>
                                                    @endif
                                                @endif
                                                @if($trip->payment)
                                                    @if($trip->payment->discount)
                                                        <h5>@lang('user.ride.promotion_applied') <span>
                                                            {{symbolcurrency($trip->payment->discount,$trip->currency_code)}}
                                                        </span></h5>
                                                    @endif
                                                @endif
                                                @if($trip->payment)
                                                    @if($trip->payment->tips)
                                                        <h5>@lang('user.ride.tips') <span>
                                                            {{symbolcurrency($trip->payment->tips,$trip->currency_code)}}
                                                        </span></h5>
                                                    @endif
                                                @endif
                                                <h5><strong>@lang('user.ride.tax_price') </strong><span><strong>
                                                @if($trip->payment)
                                                {{symbolcurrency($trip->payment->tax,$trip->currency_code)}}
                                                @endif
                                                </strong></span></h5>
                                                <h5 class="big"><strong>@lang('user.charged') - {{$trip->payment_mode}} </strong><span><strong>
                                                @if($trip->payment)
                                                {{symbolcurrency($trip->payment->total-$trip->payment->discount+$trip->payment->tips,$trip->currency_code)}}
                                                @endif
                                                </strong></span></h5>
