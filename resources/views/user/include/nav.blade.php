    ...
    <div class="dash-left">
        ...
        <div class="side-menu">
             <ul>
                ...
                <?php 
                $country_code=@App\Country::find(@Auth::user()->country_id)->code;
                $country_code =@$country_code ? $country_code : 'IN'; 
                ?>
                
                <li><a href="{{url('/wallet')}}">@lang('user.my_wallet') <span class="pull-right">{{currency(Auth::user()->wallet_balance,$country_code)}}</span></a></li>
