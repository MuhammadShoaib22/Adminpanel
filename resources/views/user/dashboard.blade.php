        ...
        <div class="row no-margin">
            <div class="col-md-6">
                <form action="{{url('confirm/ride')}}" method="GET" onkeypress="return disableEnterKey(event);">
                    ...
                    <input type="hidden" name="mapkey" id="mapkey" value="{{Setting::get('map_key')}}">
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ Setting::get('map_key') }}&libraries=places&callback=initMap&region={{@$CountryCode->code ? $CountryCode->code : 'IN'}}" ></script>
