        ...
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	...
            	<div style="text-align: center;padding: 20px;color: blue;font-size: 24px;">
            		<p><strong>
            			<span>@lang('admin.dashboard.over_earning') : {{currency($revenue[0]->overall,@Session::get('country_code','IN'))}}</span>
            			<br>
            			<span>@lang('admin.dashboard.over_commission') : {{currency($revenue[0]->commission,@Session::get('country_code','IN'))}}</span>
            		</strong></p>
            	</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<h1 class="mb-1">{{currency($revenue[0]->overall,@Session::get('country_code','IN'))}}</h1>
								                ...
								                <?php $diff = ['-success','-info','-warning','-danger']; ?>
														@foreach($rides as $index => $ride)
															<tr>
																...
																<td>{{currency($ride->payment['provider_commission'],@Session::get('country_code','IN'))}}</td>
																<td>
																...
																<td>{{currency($ride->payment['provider_pay'],@Session::get('country_code','IN'))}}</td>
