            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ currency($request->payment->fixed,@Session::get('country_code','IN')) }}</dd>
                        @if($request->service_type->calculator=='MIN')
                            <dt class="col-sm-4">@lang('admin.request.minutes_price') :</dt>
                            <dd class="col-sm-8">{{ currency($request->payment->minute,@Session::get('country_code','IN')) }}</dd>
                        @endif
                        @if($request->service_type->calculator=='HOUR')
                            <dt class="col-sm-4">@lang('admin.request.hours_price') :</dt>
                            <dd class="col-sm-8">{{ currency($request->payment->hour,@Session::get('country_code','IN')) }}</dd>
                        @endif
                        @if($request->service_type->calculator=='DISTANCE')
                            <dt class="col-sm-4">@lang('admin.request.distance_price') :</dt>
                            <dd class="col-sm-8">{{ currency($request->payment->distance,@Session::get('country_code','IN')) }}</dd>
                        @endif
                        ...
                        <dd class="col-sm-8">{{ currency($request->payment->commision,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.fleet_commission') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->fleet,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.discount_price') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->discount,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.tax_price') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->tax,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.surge_price') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->surge,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.tips') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->tips,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.total_amount') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->total+$request->payment->tips,@Session::get('country_code','IN')) }}</dd>

                        <dt class="col-sm-4">@lang('admin.request.wallet_deduction') :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->wallet,@Session::get('country_code','IN')) }}</dd>
                        ...
                        @if($request->payment->payment_mode=='CASH')
                            ...
                            <dd class="col-sm-8">{{ currency($request->payment->cash,@Session::get('country_code','IN')) }}</dd>
                        @else
                            <dt class="col-sm-4">@lang('admin.request.card_amount') :</dt>
                            <dd class="col-sm-8">{{ currency($request->payment->card,@Session::get('country_code','IN')) }}</dd>
                        @endif
                        <dt class="col-sm-4">@lang('admin.request.provider_earnings'):</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->provider_pay,@Session::get('country_code','IN')) }}</dd>
