<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li>
				<a href="{{ route('admin.dashboard') }}?country_code={{Session::get('country_code','IN')}}" class="waves-effect waves-light">
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.user.index') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.list_users')</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.provider.index') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.list_providers')</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.dispatch-manager.index') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.list_dispatcher')</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.fleet.index') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.list_fleets')</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.account-manager.index') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.list_account_managers')</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.ride.statement') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.overall_ride_statments')</a></li>
					<li><a href="{{ route('admin.ride.statement.provider') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.provider_statement')</a></li>
					<li><a href="{{ route('admin.ride.statement.today') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.daily_statement')</a></li>
					<li><a href="{{ route('admin.ride.statement.monthly') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.monthly_statement')</a></li>
					<li><a href="{{ route('admin.ride.statement.yearly') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.yearly_statement')</a></li>
				</ul>
			</li>
			...
			<li class="with-sub">
				...
				<ul>
					...
					<li><a href="{{ route('admin.transactions') }}?country_code={{Session::get('country_code','IN')}}">@lang('admin.include.all_transaction')</a></li>
				</ul>
			</li>
			...
			<li>
				<a href="{{ route('admin.requests.index') }}?country_code={{Session::get('country_code','IN')}}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-infinite"></i></span>
					<span class="s-text">@lang('admin.include.request_history')</span>
				</a>
			</li>
			<li>
				<a href="{{ route('admin.requests.scheduled') }}?country_code={{Session::get('country_code','IN')}}" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">World Country</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.country.index') }}">List World Country</a></li>
					<li><a href="{{ route('admin.country.activelist') }}">Active Country</a></li>
				</ul>
			</li>
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
				<span class="s-text">@lang('admin.include.subscription')</span>
				</a>
				<ul> 
					<li><a href="{{ route('admin.subscription.index') }}">@lang('admin.include.list_subscription')</a></li> 
					<li><a href="{{ route('admin.subscription.create') }}">
					@lang('admin.include.add_new_subscription')</a></li> 
					<li><a href="{{ route('admin.subscription.subscription_histories') }}">
					Histories</a></li>
				</ul>
			</li>
			...
			<li>
				<a href="{{ route('admin.payment') }}?country_code={{Session::get('country_code','IN')}}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-infinite"></i></span>
