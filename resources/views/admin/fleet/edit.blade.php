    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.fleet.update', $fleet->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-5">
						<input class="form-control" type="number" value="{{ $fleet->commission }}" name="commission" id="commission" placeholder="Commission">
					</div>
					<div class="col-xs-5">
						<span style="color:red">(It will work if admin commission > 0%) </span>
					</div>
				</div> 
				@if($fleet->country_id)
				<div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ @App\Country::find(@$fleet->country_id)->name }}" disabled="">
                    </div>
                </div>
                @else
				<div class="form-group row">
