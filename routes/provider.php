...
Route::get('subscribe/cards', 'ProviderController@subscribe_cards')->name('subscribe.cards');
Route::post('subscribe/card/store', 'ProviderController@subscribe_card_store'); 
Route::delete('subscribe/card/destroy', 'ProviderController@subscribe_card_destroy');

Route::get('/subscription' ,'ProviderResources\TripController@subscription');
Route::post('/subscription' ,'PaymentController@subscription_verify');
Route::get('/sub_pay' ,'PaymentController@subscription_post');
Route::get('/subscription/verify','ProviderResources\TripController@subscription_confirm');
Route::post('/send/money', 'PaymentController@send_money_trans');
