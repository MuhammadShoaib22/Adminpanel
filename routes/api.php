...
Route::get('/getCountry' , 	'UserApiController@getCountry');
...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::post('/add/money' , 	'PaymentController@api_paisa_add_money');
	// estimated
...
Route::post('/request/payment_change','UserApiController@flow_payment_change');
	//Easypaisa
	Route::get('/wallet/verify','PaymentController@api_wallet_verify');
