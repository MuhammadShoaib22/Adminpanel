...
Route::get('country/status/{id}', 'Resource\CountryResource@status')->name('country.status');

Route::get('/dispatcher/country','Resource\CountryResource@active_dispatcher');
Route::post('/dispatcher/city','Resource\CountryResource@active_dispatcher_city');

Route::get('active/country','Resource\CountryResource@active')->name('country.activelist');
Route::get('/timezone/{code}','Resource\CountryResource@time_zone');
Route::get('/state/{id}','Resource\CountryResource@respective_timezone');

Route::get('/city/{id}','Resource\CountryResource@respective_city');
Route::get('city/status/{id}', 'Resource\CountryResource@city_status');
Route::get('city/edit/{id}', 'Resource\CountryResource@city_edit');
Route::post('city/update', 'Resource\CountryResource@city_update');
Route::get('city/add/{id}', 'Resource\CountryResource@city_add');
Route::post('city/save', 'Resource\CountryResource@city_save');


Route::get('service/city/{id}/{serviceId}', 'Resource\ServiceResource@service_citywise');
Route::post('service/city/update', 'Resource\ServiceResource@service_citywise_update');

Route::get('service/city_add/{id}', 'Resource\ServiceResource@add_service_citywise');
...
Route::resource('subscription', 'Resource\SubscriptionsController');

Route::post('add_money', 'Resource\ProviderResource@add_money');

Route::get('/subscription_histories', 'Resource\SubscriptionsController@subscription_histories')->name('subscription.subscription_histories'); 
...
Route::post('/provider/subscription' ,'AdminController@subscription_post');
