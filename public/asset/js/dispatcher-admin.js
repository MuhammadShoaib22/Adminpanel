...
class DispatcherRequest extends React.Component {
    ...
    componentDidMount() {
        ...
        $.get('/admin/dispatcher/country', function(result) {
           this.setState({
               country: result
           });
       }.bind(this));
    ...
    createRide(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                {
                    this.props.completed(data.UserRequest);
                } 
            }.bind(this)
        });
    }
        ...
        return (
            <div className="card card-block" id="create-ride">
                ...
                <form id="form-create-ride" onSubmit={this.createRide.bind(this)} method="POST">
                    <div className="row">
                        ...
                        <div className="col-xs-6">
                               <div className="form-group">
                                       ...
                                       <CountryTypes data={this.state.country} submit={this.onchange.bind(this)}/>
                               </div>
                               </div>
                               ...
                               <div className="form-group">
                                       ...
                                       {this.state.cities.map(function(data){
                    ...
                    {this.state.flash == 'failed' ? 
                    <div className="alert alert-danger"> 
                    <button type="button" class="close" onClick={this.flashDiv.bind(this)}>×</button> &nbsp; &nbsp; &nbsp;
...
class CountryTypes extends React.Component {
   render() {
       // console.log('CountryTypes', this.props.data);
       var mySelectOptions = function(result) {
           return <CountryTypesOption
                   key={result.id}
                   id={result.id}
                   name={result.name} />
       };
       return (
               <select
                   name="country_id"
                   className="form-control"  onChange={this.props.submit.bind(this)} >
...
class CountryTypesOption extends React.Component {
   render() {
       return (
           <option value={this.props.id}>{this.props.name}</option>
       );
