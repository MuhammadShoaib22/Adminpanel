...
class ProviderDocumentResource extends Controller
{
    ...
    public function index(Request $request, $provider)
    {
        try {
            ...
            $ProviderService_service_ids = ProviderService::where('provider_id',$provider)->with('service_type')->pluck('service_type_id');
            $ServiceTypes = ServiceType::whereNotIn('id',$ProviderService_service_ids)->get();
