...
class DispatcherController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        try{
            ...
            $Country=Country::wherecode($cities->country_code)->first();


            $county= Country::wherecode($Country->code)->first();
            ...
            $UserRequest->country_code =$country_code;
            ...
            if($request->has('provider_auto_assign')) {
                ...
                if(count($Providers) == 0) {
                    if($request->ajax()) {
                        ...
                        return response()->json(['error' => trans('api.ride.no_providers_found'), 'message' => 'failed']); 
                    } else {
            ...
            if($request->ajax()) {
                return response()->json(['UserRequest' => $UserRequest, 'message' => 'success']);
            } else {
