...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            Auth::user()->active_subscribe = SubscriptionHistories::with('subscription')->whereprovider_id(Auth::user()->id)->wherestatus('Active')->first();
            return Auth::user();
    ...
    public function available(Request $request)
    {
        ...
        if($Provider->service) {
           ...
           $ProviderService = ProviderService::whereprovider_id(Auth::user()->id)->get();
